...
$_->title_is("Login", "Check for login title") for $ua1, $ua2;
$_->content_contains("You need to log in to use this application",
	"Check wie are NOT logged in") for $ua1, $ua2;
...
#=pod NO ENTIENDO POR QUE NO PASA
$ua1->content_contains("form_create\">Admin Create</a>",
        "'test01' should have a create link");
$ua2->content_lacks("form_create\"Admin Create</a>",
